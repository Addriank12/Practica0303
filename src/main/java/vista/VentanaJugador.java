...
public class VentanaJugador extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Equipo equipo = controladorEquipo.listar().get(jComboBox1.getSelectedIndex());
        controladorJugador.crear(args, equipo);
        updateTable();
    ...
    {
        var header = new String[] {"Nombre", "nacionalidad", "dorsal", "posicion","Edad", "Cedula", "Equipo"};
        var data = new Object[this.controladorJugador.listar().size()][7];
        
        for(int i = 0; i<this.controladorJugador.listar().size();i++)
        {
            data[i][0]=this.controladorJugador.listar().get(i).getNombre();
            data[i][1]=this.controladorJugador.listar().get(i).getNacionalidad();
            data[i][2]=this.controladorJugador.listar().get(i).getDorsal();
            data[i][3]=this.controladorJugador.listar().get(i).getPosicion();
            data[i][4]=this.controladorJugador.listar().get(i).getEdad();
            data[i][5]=this.controladorJugador.listar().get(i).getCedula();
            data[i][6]=this.controladorEquipo.listar().get(i).getNombre();
        }
